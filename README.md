...
# [autocomplete-js](http://styczynski.ml/autocomplete-js/)
...
Custom scrollbars, animations, CSS styling... literally there's anything you can do with the [autocomplete-js](http://styczynski.ml/autocomplete-js/)!

This plugin is based on the complete-ly.js idea by Lorenzo Puccetti.

To read more, see detailed examples or view API docs [see the web page](http://styczynski.ml/autocomplete-js/).
