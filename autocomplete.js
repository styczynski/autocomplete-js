...
(function($) {
    $.fn.extend({
        autocomplete: function(settings) {
            ...
            settings.scrollController.init = settings.scrollController.init || function(e) {
                return e
            };
            settings.scrollController.repaint = settings.scrollController.repaint || function() {};
            settings.scrollController.scroll = settings.scrollController.scroll || function(value) {
                if (value) dropDown.scrollTop(value);
                return dropDown.scrollTop();
            };

            settings.__event_hintChanged = createEventHandler();
            settings.__event_dropdownShown = createEventHandler(function(e) {
                e.show();
            });
            settings.__event_dropdownHidden = createEventHandler(function(e) {
                e.hide();
            });
            ...
            rs = {
                ...
                settings.__event_history_browsed = createEventHandler();
                settings.__event_key = createEventHandler();*/
                hintChanged: function(callback) {
                    settings.__event_hintChanged.push(callback);
                    return this;
                },
                dropdownShown: function(callback) {
                    settings.__event_dropdownShown.push(callback);
                    return this;
                },
                dropdownHidden: function(callback) {
                    settings.__event_dropdownHidden.push(callback);
                    return this;
                },
                confirmed: function(callback) {
                    settings.__event_confirmed.push(callback);
                    return this;
                },
                changed: function(callback) {
                    settings.__event_changed.push(callback);
                    return this;
                },
                historyBrowsed: function(callback) {
                    settings.__event_history_browsed.push(callback);
                    return this;
                },
                key: function(callback) {
                    settings.__event_key.push(callback);
                    return this;
                },
